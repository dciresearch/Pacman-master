...
class FeatureBasedGameState(object):
    def __init__(self, gameState):
        ...
        self.moveToClosestFood = self._getMoveToClosestFood()
        self.isGhostBlockingPathToClosestFood = self._isGhostWithin1UnitOfClosestFoodDirectionPoint()

    def _getMoveToClosestFood(self):
    ...
    def getLegalActions(self):
        return self.rawGameState.getLegalActions()

    def _isGhostWithin1UnitOfClosestFoodDirectionPoint(self):
    ...
    def __key(self):
        return (
            ...
            self.isGhostBlockingPathToClosestFood
        )
    ...
    def __repr__(self):
        return str({
            ...
            "isGhostBlockingPathToClosestFood": self.isGhostBlockingPathToClosestFood
        })

    # If you add a feature, add it here too
    # This is required by pickle to store the model from the file
    def __getstate__(self):
        return (self.moveToClosestFood, self.isGhostBlockingPathToClosestFood)

    # If you add a feature, add it here too
    # This is required by pickle to retrieve the model from the file
    def __setstate__(self, state):
        self.moveToClosestFood = state[0]
        self.isGhostBlockingPathToClosestFood = state[1]
